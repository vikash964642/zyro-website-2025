...
// export default function ConnectedCardSlider() {
//   useEffect(() => {
//     gsap.utils.toArray(".card1").forEach((card) => {
//       gsap.from(card, {
//         scrollTrigger: {
//           scroller: "body",
//           // markers: true,
...
//         and streamline payments from a single dashboard.
//       </p>
//       <div className=" flex flex-wrap gap-4 justify-center xl:justify-between mt-[35px] lg:mt-[45px]">
//         {contentData.map((item, index) => (
//           <div
//             key={index}
//             className="card1 sticky lg:static min-w-[250px] max-w-[325px] min-h-[420px] flex flex-col  transform transition-transform duration-300 ease-in-out hover:scale-[1.04]"
