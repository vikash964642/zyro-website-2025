...
//     paragraph:
//       "This allow businesses to easily set up accounts and use services, making financial tasks simpler and enhancing overall efficiency.",
//   },
//   {
//     id: 2,
...
//   return (
//     <section className="max-w-screen-xl mx-auto px-4 xl-px-0 mt-[100px] lg:mt-[125px]">
//       <h2 className="max-[360px]:text-[25px] text-center text-[28px] lg:text-[48px] text-white90 font-medium mb-12">
//          Why choose <span className="verticlesliderZyroGradient max-[360px]:text-[25px]   text-[28px] lg:text-[48px] font-bold">ZYRO</span> Connected Banking for your Business
//       </h2>
