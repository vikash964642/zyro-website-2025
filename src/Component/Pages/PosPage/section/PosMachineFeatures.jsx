...
<section className="max-w-screen-lg lg:mx-auto px-[20px] xl:px-[0px] mt-[180px] lg:mt-[150px] relative">
    <div className='hidden lg:block bg-[#0E0624] rounded-[10px] relative overflow-hidden'>
         <div className='PosMachineGradientTop'></div>
        <h2 className='lg:text-[34px] font-semibold PosMachineHeaderGradient text-center pt-[50px]'>What You Get in the box?</h2>
          ...
          <div className='flex  pr-[30px]'>
            ...
            <div className='flex items-center'>
                <div className='flex flex-col gap-[40px]'>
                    <div className='h-[56px] w-[250px] gradiantzyx rounded-[20px] flex items-center justify-center'>
                      <div className='  rounded-[20px]  bg-[#080219] flex items-center pl-[14px] h-[calc(100%-2px)] w-[calc(100%-2px)]'>
                        <p className='lg:text-[14px] font-normal text-[#FFF] leading-0'>Quick Operation Guide</p>
                    </div>
                    </div>
                   <div className='h-[56px] w-[250px] gradiantzyx rounded-[20px] flex items-center justify-center'>
                      <div className='rounded-[20px]  bg-[#080219] flex items-center px-[14px] h-[calc(100%-2px)] w-[calc(100%-2px)]'>
         ...
         <div className='PosMachineGradientBottom'></div>
    <div className='block lg:hidden relative'>
       ...
       <div className='pt-[55px]'>
         <div className='h-[48px] w-[220px] gradiantzyx rounded-[12px] flex items-center justify-center'>
           <div className=' rounded-[12px]  bg-[#080219] h-[calc(100%-2px)] w-[calc(100%-2px)] flex  items-center px-[14px]'>
                        <p className='text-[12px] font-normal text-[#FFF]'>Quick Operation Guide</p>
                    </div>
         </div>
                    
                     <div className='h-[48px] w-[220px] gradiantzyx rounded-[12px] flex items-center justify-center my-[15px]'>
           <div className=' rounded-[12px]  bg-[#080219] h-[calc(100%-2px)] w-[calc(100%-2px)] flex  items-center px-[14px]'>
