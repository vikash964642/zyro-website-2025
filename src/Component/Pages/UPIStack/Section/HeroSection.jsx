...
<div className='hidden md:flex justify-center pt-[45px]'>
                   <button className='bg-[#4F31B4] rounded-[24.77px] h-[46px] w-[148px] text-[18px] font-semibold text-[#FFF]'>Contact Us</button>
</div>
...
<div className='flex md:hidden justify-center pt-[85px] max-[360px]:px-[15px]'>
                   <button className='bg-[#4F31B4] rounded-[24.77px] h-[50px] max-[360px]:w-full w-[325px] text-[22px] font-semibold text-[#FFF]'>Contact Us</button>
</div>
               </div>
               </section>
  )
