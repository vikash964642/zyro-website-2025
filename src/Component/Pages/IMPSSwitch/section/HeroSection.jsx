...
<div className='flex items-center justify-between flex-col lg:flex-row gap-[32px]'>
    <div className='flex flex-col items-center lg:items-start '>
        ...
        <button onClick={() => handleLinkClick("IMPS Switch")} className='mt-[50px] w-[148.6px] h-[46px] bg-[#4F31B4] rounded-[24.77px] hidden lg:flex justify-center items-center text-[18.1px] text-[#FFF] font-semibold'>Contact Us</button>
    </div>
    ...
    {/* <img src={IMPSHeroSectionImgMob} className='block lg:hidden px-[20px] sm:px-0 sm:w-[370px] md:w-[425px]'/> */}
      <button onClick={() => handleLinkClick("IMPS Switch")} className='mt-[40px] max-[360px]:w-[300px] max-[360px]:h-[50px] w-[325px] h-[55px] bg-[#4F31B4] rounded-[30px] flex justify-center items-center lg:hidden text-[22px] text-[#FFF] font-semibold'>Contact Us</button>
</div>
             </div>
      </section>
  )
