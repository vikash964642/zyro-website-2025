...
const cards = [
  {
    ...
    paragraph: "Upload receipts digitally with smart categorization & built-in audit trails for enhanced accuracy.",
  },
  {
    image: ReduceFraud,
    heading: "Reduce Fraud & Misuse",
    paragraph: "Integrated audit trails and policy controls help prevent duplicate or non-compliant claims.",
  },
  {
    image: realtime,
  ...
  return (
   <section className="min-h-[90vh] flex items-center">
      ...
      <div className="mt-[131px] max-w-screen-xl mx-auto px-[19px] relative">
        ...
        <p className="featuremanagementHead w-[390px] lg:w-[693px] text-[24px] lg:text-[34px] font-semibold leading-[39px] lg:leading-[45px] lg:text-left text-center ">
...
</div>        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10">
