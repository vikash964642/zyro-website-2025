...
function ZyroSoundBox() {
  return (
    <section className="max-w-screen-lg mx-auto mt-[155px]">
        <div className='lg:flex justify-between items-center'>
            <div className='lg:w-[50%] p-3'>
                ...
                <p className="text-white text-[20px] lg:text-[31.83px] font-medium leading-[28px] mt-[18px] align-middle text-center lg:text-left px-[40px] lg:px-[0px] ">Get Real Time & Instant Audio Confirmations on Successful Payments</p>
