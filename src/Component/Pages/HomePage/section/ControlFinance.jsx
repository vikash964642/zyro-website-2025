...
function ControlFinance() {
  ...
  return (
    ...
    <p className="max-[375px]:text-[14px] text-[18px] lg:text-[29px] text-white70 font-normal pt-[19px] ">Accelerate your business with ZYRO</p>
     ...
     <Link to='/contact-us' onClick={ScrollTop} className="h-[45px] w-[140px] bg-[#4F31B4] rounded-[44px] shadow-ControlFinance-custom-shadow text-[#FFF] text-[16px] font-medium mt-[45px] flex justify-center items-center">Get Started</Link>
      </div>
    </section>
  );
}
