  ...
  return (
    <section style={{backgroundImage:`url(${sape})`}} className=" sap bg-center bg-no-repeat bg-contain min-h-[80vh] flex justify-center items-center">
      <div  className=" max-w-screen-lg mx-auto flex justify-center items-center flex-col relative ">
        ...
        <p className="max-[360px]:text-[24px] text-[28px] lg:text-[45px] text-white90 font-medium max-[360px]:w-full w-[327px] sm:w-full text-center px-[20px] lg:px-0">Take control of your Finance now</p>  
    <p className="max-[375px]:text-[14px] text-[18px] lg:text-[29px] text-white70 font-normal pt-[19px] text-center px-[20px] lg:px-0 ">Accelerate your business with ZYRO</p>
