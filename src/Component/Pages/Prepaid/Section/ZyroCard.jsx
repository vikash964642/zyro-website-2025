...
import ZyroCardImg1 from '../../../../../public/image/Prepaid/ZyroCardImg1.webp'
import ZyroCardImg2 from '../../../../../public/image/Prepaid/ZyroCardImg2.webp'
import ZyroCardImg3 from '../../../../../public/image/Prepaid/ZyroCardImg3.webp'
        ...
        <div>
            <div>
               ...
               <div className='pt-[34px]'>
                 <div className='flex justify-center items-center h-[43px] w-[43px] border-[0.311px] border-[#A901A3] rounded-[9.05px] bg-[#080219]'>
                <img src={ZyroCardImg2} className='h-[26px] w-[19.717px]'/>
                 </div>
               ...
               <div className='pt-[34px]'>
                 <div className='flex justify-center items-center h-[43px] w-[43px] border-[0.311px] border-[#A901A3] rounded-[9.05px] bg-[#080219]'>
                <img src={ZyroCardImg3} className='h-[25.68px] w-[20.5px]' />
                 </div>
