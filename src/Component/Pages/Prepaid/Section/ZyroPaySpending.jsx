...
<div className='h-[100%] w-[100%] pt-[50px] pb-[28px] max-[360px]:px-[15px] px-[25px] md:px-[20px] lg:px-[45px] flex md:flex-row flex-col  items-center justify-between lg:gap-[40px]'>
    ...
    <h3 className='max-[360px]:text-[20px] text-[22px] lg:text-[34px] font-semibold ZyroPaySpendingHeaderGradient2'>Manage <sapn className='max-[360px]:text-[20px] text-[22px] font-semibold  lg:text-[30px] lg:font-medium'>everything on the go with the</sapn> ZyroPay App</h3>
